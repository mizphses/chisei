<template>
  <!-- ["知性", "未来", "過去", "想像", "多摩キャン", "夢", "ツイッター", "教授", "電車", "バス", "CPlus", "Manaba", "ジンギスカン", "モノレール", "Temico", "多摩", "多摩動物公園", "学費", "基礎マクロ経済学", "テミス", "信用", "知性", "知性", "中央大学", "フォレゲ", "iTL", "Cスクエア", "学生", "インスタ", "Webex", "インターン", "労働", "鉛筆", "バイト", "クラウドキャンパス", "Word", "Excel", "Powerpoint", "性別"],
      verblist: ["死亡", "行動", "絶起", "過労", "忘却", "落下", "喪失", "獲得", "登録", "落単", "会話", "増加", "遊戯", "停止", "変化", "編集", "殺害", "惹起", "克服", "過誤", "錯誤", "盗聴", "見落し", "引受", "掃出", "放送", "祈願", "脱出", "追越", "エンカ", "要求", "咀嚼", "束縛", "鳴動", "夢想", "含有", "所持", "据付", "入手", "性行"], -->
  <div class="container">
